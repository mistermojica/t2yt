...
def create_video_with_background_video(elementos_partes, titulo, output_filename, background_music):
    ...
    if 'narration' in elementos:
        ...
        # video_temp = mpe.concatenate_videoclips([thumbnail_clip, video])
        # clips = [thumbnail_clip] + [video] + narration_clips + [thumbnail_clip]

        # video_all = mpe.CompositeVideoClip([thumbnail_clip]clips)
